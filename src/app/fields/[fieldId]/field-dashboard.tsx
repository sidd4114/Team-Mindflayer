...
import FieldInsightCard from "@/components/FieldInsightCard";
        ...
        <div className="min-h-screen pb-32">
            <div className="max-w-3xl mx-auto px-4 sm:px-6">
                ...
                <main className="space-y-4 sm:space-y-5 pt-2">
                    ...
                    {/* AI Field Insight (Gemini) */}
                    <FieldInsightCard
                        fieldId={fieldId}
                        data={{
                            cropType: fieldInfo.crop_type,
                            date: selectedDate,
                            ndvi: healthScore,
                            moisture: sarData ? { status: sarData.moistureLevel, message: sarData.message } : undefined,
                            terrain: terrainData,
                            vci: vciDataState,
                            alerts: alerts,
                    ...
                    <div className="card rounded-2xl p-4">
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide justify-center">
                            {VEGETATION_INDICES.map(({ id, label, Icon, color }) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex flex-col items-center gap-1.5 px-3 py-2.5 rounded-xl border-2 min-w-18 transition-all shrink-0 ${isSelected
                            ...
                            <div className="card rounded-2xl p-4 sm:p-5 border-l-4 border-l-cyan-500">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span
                                            className={`font-bold px-3 py-1.5 rounded-lg text-sm border ${sarData.moistureLevel === "wet"
                                    ...
                                    <div className="px-1">
                                        <p className="text-xs text-slate-500 leading-relaxed">
                                            To view the visual moisture map, select <span className="font-bold text-cyan-700">NDMI</span> from the map options above.
                                        </p>
                                    </div>
